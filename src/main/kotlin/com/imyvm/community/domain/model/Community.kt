...
class Community(
    ...
    var communityIncome: ArrayList<Turnover> = arrayListOf(),
    ...
    var fiscalState: CommunityFiscalState = CommunityFiscalState(),
    var developmentState: CommunityDevelopmentState = CommunityDevelopmentState()
) {
    fun isManor(): Boolean {
