        ...
        renderList(announcements, announcementsPerPage, startSlot) { announcement, slot, _ ->
            ...
            addButton(
                ...
                itemStack = getLoreButton(
                    ...
                    listOf(
                        Translator.tr("ui.admin.announcement_list.lore.author", authorName) ?: Text.of("By: $authorName"),
                        Translator.tr("ui.admin.announcement_list.lore.time", timeFormatted) ?: Text.of("Time: $timeFormatted"),
                        Translator.tr("ui.admin.announcement_list.lore.preview", preview) ?: Text.of(preview)
                    )
                ),
