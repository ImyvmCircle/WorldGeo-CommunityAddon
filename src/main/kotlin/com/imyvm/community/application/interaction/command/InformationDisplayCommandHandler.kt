...
fun onHelpCommand(player: ServerPlayer): Int {
    ...
    player.sendSystemMessage(Translator.tr("community.command.help.section_fiscal"))
    player.sendSystemMessage(Translator.tr("community.command.help.fiscal_policy"))
    player.sendSystemMessage(Translator.tr("community.command.help.fiscal_preview"))
    player.sendSystemMessage(Translator.tr("community.command.help.fiscal_settle"))
    player.sendSystemMessage(Translator.tr("community.command.help.fiscal_history"))
